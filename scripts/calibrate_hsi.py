...
for raw_hdr in sorted(glob(raw_glob)):
    ...
    white_reference_hs_data, white_cube_metadata = load_hyperspectral_cube(white_hdr)
    dark_reference_hs_data, dark_cube_metadata = load_hyperspectral_cube(dark_hdr)
    raw_hs_data, raw_cube_metadata = load_hyperspectral_cube(raw_hdr)
...
print("Data calibration complete!")
print("Ready for band reduction script (scripts/reduce_dimensions_hsi.py)")